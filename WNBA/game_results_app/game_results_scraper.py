...
output_file = os.path.join(save_path, "game_results_2025.csv")
    ...
    for game in games:
        try:
            ...
            all_games.append({
                ...
                'HomeScore': home.get('score', None),
                'AwayTeam': away['team']['shortDisplayName'],
                'AwayScore': away.get('score', None),
...
if all_games:
    ...
    print(f"✅ Schedule saved to {output_file} with {len(df)} games.")
else:
